    ...
    function statusCheck() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(hostPath(), { method: 'HEAD', mode: 'no-cors' })
                            .then(function (response) { return response && (response.ok || response.type === 'opaque'); })
                            .catch(function (error) { return false && console.warn('[Connection test failed]:', error); })];
                    case 1:
                        isOnline = _a.sent();
                        // [JSInvokable]
